...
rc = pd.read_csv('/root/tlbrc_paper/ref/_tlbrc_trades.csv')  # CORRECTED validated reclaim book
rc['dt'] = etdate(rc['entry_t'])
RCLM = rc.assign(usd=rc['r'] * rc['risk'] * MNQ * 1).groupby('dt')['usd'].sum()
